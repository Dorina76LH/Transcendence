...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'username', 'email', 'first_name', 'last_name', 'avatar', 'avatar_url', 'is_online', 'role', 'is_2fa_enabled')
        # Safety: these cannot be modified via this serializer.
        read_only_fields = ('id', 'username', 'role', 'is_2fa_enabled', 'avatar_url')
