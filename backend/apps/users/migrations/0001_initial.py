    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_secret', models.CharField(blank=True, max_length=32, verbose_name='2FA secret key')),
                ('role', models.CharField(choices=[('user', 'User'), ('admin', 'Admin')], default='user', max_length=20, verbose_name='User role')),
