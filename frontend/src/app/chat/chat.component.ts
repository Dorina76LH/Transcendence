    ...
    <main class="main">
      <div class="content px-4">
        <div class="container-fluid h-100">
          <div class="row h-100">
            <div
              class="col-12 col-md-3 border-end border-secondary py-3 text-start list-container"
              [class.hide-on-mobile]="selectedFriend !== null"
            >
              <h5 class="text-white mb-4 px-2 tracking-wider">My Friends</h5>
              <div
                class="d-flex flex-column gap-1 list-box"
              ...
              >
                ...
                >
                  <div
                    class="avatar-circle me-3 bg-gradient d-flex align-items-center justify-content-center shadow-sm fw-bold position-relative"
                  ...
                  >
                    ...
                    />
                    <span *ngIf="!friend.avatar">{{
                      friend.username.charAt(0).toUpperCase()
                    }}</span>
                    <span
                      *ngIf="friend.is_online"
            ...
            <div
              class="col-12 col-md-9 d-flex flex-column py-3 px-3 chat-main-container"
              [class.hide-on-mobile]="selectedFriend === null"
            >
              <h5
                class="border-bottom border-secondary pb-2 text-white text-start d-flex align-items-center justify-content-between gap-2"
              >
              ...
              <div
                #scrollContainer
                class="flex-grow-1 overflow-auto mb-3 p-3 rounded shadow-inner chat-window-box"
              >
                ...
                >
                  ...
                  <div
                    class="p-2 px-3 rounded-4 shadow-sm message-bubble border text-start"
...
export class ChatComponent implements OnInit, OnDestroy {
  ...
  selectFriend(friend: Friend) {
    ...
    this.messages = [];
    this.http
      .post<Conversation>('https://localhost:8443/api/chat/conversations/create/', {
  ...
  private fetchMessages(convId: number) {
    this.http
      .get<ChatMessage[]>(`https://localhost:8443/api/chat/conversations/${convId}/messages/`)
      .subscribe((history) => {
  ...
  connectToWebSocket(conversationId: number) {
    ...
    const socket = new WebSocket(
      `wss://localhost:8443/ws/chat/conversations/${conversationId}/?token=${token}`,
    );
